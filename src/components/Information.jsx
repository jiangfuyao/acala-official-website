    ...
    return (
        <div>
            ...
            <p className={classes.acalaDescribe}>
                Acala Dollar is a type of cryptocurrency that is referred to as a stablecoin. You can always redeem 1 Acala Dollar for US$1.00, giving it a stable price. On Acala, eligible customers can earn rewards for every Acala Dollar they hold.
            </p>
